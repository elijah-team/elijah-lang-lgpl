...
find ../elijah-lang/src ../elijah-lang//test ../elijah-lang/buffer/ -type f | grep -v .idea | grep -v .class | grep -v Lexer | grep -v Parser | grep -v jar | grep -v zip | grep -v .m2 | grep -v antlr > list
