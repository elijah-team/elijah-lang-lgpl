...
find ../elijah-lang -type f | grep -v .git | grep -v Lexer | grep -v jar | grep -v zip | grep -v .m2 | grep -v class | grep -v antlr > list
cat list |  xargs md5sum >> ../elijah-lang-`date +%b%d-%H%M`.txt
echo =========*=========*=========*=========*=========*=========*=========*=========*=========*=========* >> ../elijah-lang-`date +%b%d-%H%M`.txt
cat list |  xargs pr -f -l 80 -c | nl >> ../elijah-lang-`date +%b%d-%H%M`.txt
rm list
