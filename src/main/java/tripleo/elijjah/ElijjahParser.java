...
inputState.guessing--;
	...
	public final void postConditionSegment(
		...
		try {      // for error handling
			match(LITERAL_post);
			{
			if ((LA(1)==LCURLY) && (_tokenSet_45.member(LA(2)))) {
				match(LCURLY);
				{
				_loop101:
				do {
	...
	public final Postcondition  postcondition() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			else if ((_tokenSet_18.member(LA(1))) && (_tokenSet_48.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
	...
	public final IExpression  assignmentExpression() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			else if ((_tokenSet_7.member(LA(1))) && (_tokenSet_54.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
...
inputState.guessing--;
	...
	public final void constructExpression(
		...
		try {      // for error handling
			...
			q=qualident();
			{
			if ((LA(1)==LPAREN) && (_tokenSet_57.member(LA(2)))) {
				match(LPAREN);
				{
				switch ( LA(1)) {
				case IDENT:
	...
	public final IExpression  postfixExpression() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			do {
				...
				else if ((LA(1)==LPAREN) && (_tokenSet_57.member(LA(2)))) {
					lp = LT(1);
					match(LPAREN);
					{
					switch ( LA(1)) {
	...
	public final NormalTypeName  normalTypeName2() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			else if ((_tokenSet_2.member(LA(1))) && (_tokenSet_54.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
