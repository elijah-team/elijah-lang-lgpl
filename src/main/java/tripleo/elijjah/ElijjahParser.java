...
inputState.guessing--;
	...
	public final IExpression  relationalExpression() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			if ((_tokenSet_8.member(LA(1))) && (_tokenSet_69.member(LA(2)))) {
				...
				_loop305:
				do {
					if ((_tokenSet_72.member(LA(1))) && (_tokenSet_18.member(LA(2)))) {
						{
						switch ( LA(1)) {
						case LT_:
						{
			...
			else if ((LA(1)==LITERAL_is_a) && (_tokenSet_73.member(LA(2)))) {
				match(LITERAL_is_a);
				tn=typeName2();
				if ( inputState.guessing==0 ) {
	...
	public final IExpression  postfixExpression() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			do {
				...
				else if ((LA(1)==LPAREN) && (_tokenSet_74.member(LA(2)))) {
					lp = LT(1);
					match(LPAREN);
					{
					switch ( LA(1)) {
			...
			{
			if ((LA(1)==AS||LA(1)==CAST_TO) && (_tokenSet_73.member(LA(2)))) {
				if ( inputState.guessing==0 ) {
	...
	public final void funcExpr(
		...
		try {      // for error handling
			...
			case LCURLY:
			{
				...
				_loop341:
				do {
					if ((_tokenSet_43.member(LA(1))) && (_tokenSet_75.member(LA(2)))) {
						statement(sc.statementClosure(), sc.getParent());
					}
					else if ((_tokenSet_18.member(LA(1))) && (_tokenSet_19.member(LA(2)))) {
						expr=expression();
	...
	public final NormalTypeName  normalTypeName2() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			{
			if ((LA(1)==LBRACK) && (_tokenSet_73.member(LA(2)))) {
				match(LBRACK);
				rtn=typeNameList2();
				if ( inputState.guessing==0 ) {
			...
			else if ((_tokenSet_3.member(LA(1))) && (_tokenSet_78.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
	...
	public final GenericTypeName  genericTypeName2() throws RecognitionException, TokenStreamException {
		...
		try {      // for error handling
			...
			{
			if ((LA(1)==LT_) && (_tokenSet_73.member(LA(2)))) {
				match(LT_);
				tn2=typeName2();
				if ( inputState.guessing==0 ) {
			...
			else if ((_tokenSet_8.member(LA(1))) && (_tokenSet_78.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
	...
	public final void formalArgListItem_priv(
		...
		try {      // for error handling
			...
			else if ((LA(1)==IDENT) && (_tokenSet_82.member(LA(2)))) {
			}
			else {
				throw new NoViableAltException(LT(1), getFilename());
			}
