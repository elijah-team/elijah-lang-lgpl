...
public ElijjahLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("get", this), new Integer(118));
	literals.put(new ANTLRHashString("destructor", this), new Integer(41));
	literals.put(new ANTLRHashString("exception", this), new Integer(25));
	literals.put(new ANTLRHashString("construct", this), new Integer(55));
	...
	literals.put(new ANTLRHashString("typeof", this), new Integer(109));
	literals.put(new ANTLRHashString("import", this), new Integer(36));
	literals.put(new ANTLRHashString("dtor", this), new Integer(42));
	literals.put(new ANTLRHashString("prop", this), new Integer(116));
	literals.put(new ANTLRHashString("invariant", this), new Integer(57));
	literals.put(new ANTLRHashString("pre", this), new Integer(47));
	literals.put(new ANTLRHashString("set", this), new Integer(119));
	literals.put(new ANTLRHashString("immutable", this), new Integer(49));
	literals.put(new ANTLRHashString("func", this), new Integer(110));
	literals.put(new ANTLRHashString("proc", this), new Integer(111));
	literals.put(new ANTLRHashString("access", this), new Integer(58));
	literals.put(new ANTLRHashString("generic", this), new Integer(107));
	literals.put(new ANTLRHashString("continue", this), new Integer(43));
	literals.put(new ANTLRHashString("post", this), new Integer(48));
	literals.put(new ANTLRHashString("match", this), new Integer(101));
	literals.put(new ANTLRHashString("extend", this), new Integer(15));
	literals.put(new ANTLRHashString("cast_to", this), new Integer(5));
	literals.put(new ANTLRHashString("ctor", this), new Integer(40));
	literals.put(new ANTLRHashString("do", this), new Integer(104));
	...
	literals.put(new ANTLRHashString("namespace", this), new Integer(34));
	literals.put(new ANTLRHashString("function", this), new Integer(96));
	literals.put(new ANTLRHashString("is_a", this), new Integer(79));
	literals.put(new ANTLRHashString("elseif", this), new Integer(100));
	literals.put(new ANTLRHashString("ref", this), new Integer(114));
	literals.put(new ANTLRHashString("while", this), new Integer(103));
	literals.put(new ANTLRHashString("const", this), new Integer(19));
	literals.put(new ANTLRHashString("abstract", this), new Integer(23));
	literals.put(new ANTLRHashString("from", this), new Integer(35));
	literals.put(new ANTLRHashString("annotation", this), new Integer(24));
	literals.put(new ANTLRHashString("break", this), new Integer(44));
	literals.put(new ANTLRHashString("out", this), new Integer(113));
	literals.put(new ANTLRHashString("return", this), new Integer(45));
	literals.put(new ANTLRHashString("property", this), new Integer(117));
	literals.put(new ANTLRHashString("if", this), new Integer(98));
	literals.put(new ANTLRHashString("yield", this), new Integer(54));
	literals.put(new ANTLRHashString("constructor", this), new Integer(39));
	literals.put(new ANTLRHashString("iterate", this), new Integer(105));
	literals.put(new ANTLRHashString("struct", this), new Integer(20));
	literals.put(new ANTLRHashString("val", this), new Integer(52));
	literals.put(new ANTLRHashString("package", this), new Integer(6));
	literals.put(new ANTLRHashString("else", this), new Integer(99));
	literals.put(new ANTLRHashString("var", this), new Integer(51));
	literals.put(new ANTLRHashString("with", this), new Integer(46));
