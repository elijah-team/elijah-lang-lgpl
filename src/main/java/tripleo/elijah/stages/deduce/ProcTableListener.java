...
public class ProcTableListener implements BaseTableEntry.StatusListener {
	...
	private final DeduceTypes2.DeduceClient2 dc;
	private final ElLog LOG;

	public ProcTableListener(ProcTableEntry pte, BaseGeneratedFunction generatedFunction, DeduceTypes2.DeduceClient2 dc) {
		this.pte = pte;
...
//		pte.setResolvedElement(e); // README already done
	...
	private void resolved_element_pte_FunctionDef(Constructable co, ProcTableEntry pte, AbstractDependencyTracker depTracker, FunctionDef fd) {
		FunctionInvocation fi;
		GenType genType;
	...
	private void resolved_element_pte_FunctionDef_FormalArgListItem(Constructable co, ProcTableEntry pte, AbstractDependencyTracker depTracker, FunctionDef fd, FormalArgListItem parent) {
	...
	private void resolved_element_pte_FunctionDef_IdentExpression(Constructable co, ProcTableEntry pte, AbstractDependencyTracker depTracker, FunctionDef fd, IdentExpression parent) {
