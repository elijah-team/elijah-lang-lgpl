...
public class ElijahParser extends antlr.debug.LLkDebuggingParser
       implements ElijahTokenTypes
 {
private static final String _ruleNames[] = {
  "program",
  "constantValue",
  "qualident",
  "programStatement",
  ...
  "structTypeName",
  "genericQualifiers",
  "abstractGenericTypeName_xx",
  "specifiedGenericTypeName_xx",
  "formalArgTypeName",
  "funcTypeExpr",
  "simpleTypeName_xx",
  "variableQualifiers",
...
public ElijahParser(ParserSharedInputState state) {
  ...
  tokenNames = _tokenNames;
	...
	public final String  qualident() throws RecognitionException, TokenStreamException {
		String pc;
		...
		try { // debugging
			Token  r1 = null;
			Token  r2 = null;
			StringBuffer r=new StringBuffer();pc=null;
	...
	private final void classInheritance(
		ClassInheritance ci
	) throws RecognitionException, TokenStreamException {
	...
	public final void varStmt(
		...
		try { // debugging
			...
			case LITERAL_const:
			{
				match(LITERAL_const);
				if ( inputState.guessing==0 ) {
					vsq =pc.varSeq();vsq.defaultModifiers(TypeModifiers.CONST);
				}
				break;
			}
			default:
	...
	public final void baseStatement(
		StatementClosure pc
	) throws RecognitionException, TokenStreamException {
	...
	public final void procedureCallExpression(
		StatementClosure pc
	) throws RecognitionException, TokenStreamException {
	...
	private final void elseif_part(
		IfExpression ifex
	) throws RecognitionException, TokenStreamException {
	...
	public final void regularQualifiers(
		...
		try { // debugging
			...
			default:
				...
				else if ((LA(1)==LITERAL_const||LA(1)==LITERAL_ref) && (LA(2)==IDENT||LA(2)==LITERAL_ref||LA(2)==LITERAL_generic)) {
					{
					{
					switch ( LA(1)) {
					case LITERAL_const:
	...
	private final void formalArgListItem_priv(
	...
	public final VariableReference variableReference() throws RecognitionException, TokenStreamException {
		...
		try { // debugging
			...
			do {
				if ((LA(1)==DOT)) {
					...
					procCallEx2();
					if ( inputState.guessing==0 ) {
						vr.addProcCallPart(out.popProcCall());
					}
				}
				else {
					break _loop183;
